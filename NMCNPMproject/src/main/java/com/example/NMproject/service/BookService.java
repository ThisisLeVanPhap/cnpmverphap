...
public class BookService {
	...
	public void addBook(BookDTO bookDTO) {
		...
		book.setImageLink(bookDTO.getPathPicture());
		...
		book.setRateAverage(bookDTO.getRateAverage());
	...
	public BookDTO updateBook(Long id, BookDTO bookDTO) {
		...
		existingBook.setImageLink(bookDTO.getPathPicture());
		...
		existingBook.setRateAverage(bookDTO.getRateAverage());
		...
		return BookDTO.builder().bookID(updatedBook.getBookId()).title(updatedBook.getTitle())
				...
				.publishDate(updatedBook.getPublishDate()).pathPicture(updatedBook.getImageLink())
				...
				.quantityValid(updatedBook.getQuantityValid()).rateAverage(updatedBook.getRateAverage()).build();
	}
